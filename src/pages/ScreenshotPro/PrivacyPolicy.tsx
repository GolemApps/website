		...
		<>
			...
			<Container maxWidth="md" sx={{ py: 4 }}>
				...
				<p>
					...
					devices, which was developed by UtilitySoft Labs (hereinafter referred
					to as "Service Provider") as a an Ad Supported service. This service
					is provided "AS IS".
				</p>
				<p>
					<strong>
				...
				<p>
					* &nbsp; Geolocation Services: The Service Provider utilizes location
					...
					Improvements: Aggregated and anonymized location data helps the
					Service Provider to analyze user behavior, identify trends, and
				...
				<ul>
					...
					<li>
						<a target="_blank" href="https://privacy.oath.com" rel="noopener">
							Flurry Analytics
						</a>
					</li>
					<li>
						<a target="_blank" href="https://sentry.io/privacy/" rel="noopener">
							Sentry
						</a>
					</li>
					<li>
					...
					<li>
						<a target="_blank" href="https://adapty.io/privacy" rel="noopener">
							Adapty
						</a>
					</li>
				</ul>
